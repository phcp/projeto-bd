...
class FuncionariosControllerTest < ActionController::TestCase
  ...
  test "should create funcionario" do
    assert_difference('Funcionario.count') do
      post :create, funcionario: { cargo: @funcionario.cargo, cpf: @funcionario.cpf, pessoa_id: @funcionario.pessoa_id, senha: @funcionario.senha }
    end
  ...
  test "should update funcionario" do
    patch :update, id: @funcionario, funcionario: { cargo: @funcionario.cargo, cpf: @funcionario.cpf, pessoa_id: @funcionario.pessoa_id, senha: @funcionario.senha }
    assert_redirected_to funcionario_path(assigns(:funcionario))
  end
