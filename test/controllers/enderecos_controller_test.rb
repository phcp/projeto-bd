...
class EnderecosControllerTest < ActionController::TestCase
  ...
  test "should create endereco" do
    assert_difference('Endereco.count') do
      post :create, endereco: { bairro: @endereco.bairro, cep: @endereco.cep, cidade: @endereco.cidade, complemento: @endereco.complemento, estado: @endereco.estado, logradouro: @endereco.logradouro, numero: @endereco.numero }
    end
  ...
  test "should update endereco" do
    patch :update, id: @endereco, endereco: { bairro: @endereco.bairro, cep: @endereco.cep, cidade: @endereco.cidade, complemento: @endereco.complemento, estado: @endereco.estado, logradouro: @endereco.logradouro, numero: @endereco.numero }
    assert_redirected_to endereco_path(assigns(:endereco))
  end
