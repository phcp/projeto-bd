...
class ProdutosControllerTest < ActionController::TestCase
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post :create, produto: { codigo: @produto.codigo, descricao: @produto.descricao, nome: @produto.nome, preco: @produto.preco, quantidade: @produto.quantidade }
    end
  ...
  test "should update produto" do
    patch :update, id: @produto, produto: { codigo: @produto.codigo, descricao: @produto.descricao, nome: @produto.nome, preco: @produto.preco, quantidade: @produto.quantidade }
    assert_redirected_to produto_path(assigns(:produto))
  end
