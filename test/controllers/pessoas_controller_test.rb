...
class PessoasControllerTest < ActionController::TestCase
  ...
  test "should create pessoa" do
    assert_difference('Pessoa.count') do
      post :create, pessoa: { email: @pessoa.email, endereco_id: @pessoa.endereco_id, nome: @pessoa.nome, telefone: @pessoa.telefone }
    end
  ...
  test "should update pessoa" do
    patch :update, id: @pessoa, pessoa: { email: @pessoa.email, endereco_id: @pessoa.endereco_id, nome: @pessoa.nome, telefone: @pessoa.telefone }
    assert_redirected_to pessoa_path(assigns(:pessoa))
  end
